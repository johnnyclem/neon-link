...
| **[docs/SOLAROS_PORTS_HANDOFF.md](docs/SOLAROS_PORTS_HANDOFF.md)** | Firmware | Handoff — three ports from the SolarOS evaluation: EPD fast refresh + region partials, the idle power pass (brightness/dimming/render throttling), and OSC control |
| **[docs/OSC.md](docs/OSC.md)** | Everyone | OSC over UDP — `/neon/*` remote control (TouchOSC-ready) in, tempo/playing/beat/peers out. Off by default |
...
See **[docs/LINKSYNC_EPD.md](docs/LINKSYNC_EPD.md)**. MIDI DIN / 6N138
adapters: **[docs/elecrow_epaper_adapters.md](docs/elecrow_epaper_adapters.md)**.
