...
| **[docs/FRIENDS_FAMILY_HANDOFF.md](docs/FRIENDS_FAMILY_HANDOFF.md)** | Hardware / Firmware | Friends & family batch ship gates (G1–G5), should-fix list, and D2 SPDIF decision |
